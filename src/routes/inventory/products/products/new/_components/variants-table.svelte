<script lang="ts">
	...
	import type { Attribute, Tax } from '$lib/api/types';
	...
	import type { ProductAttributeSchema, ProductVariantSchema } from '$lib/schemas';
	...
	export let productAttributes: ProductAttributeSchema[];
